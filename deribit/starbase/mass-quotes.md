...
| 4     | correlationId | int64 | 8      | Client-assigned ID                                                                                                                                                                                                                                        |
| 5     | mmpGroupId    | int64 | 8      | Identifier of MMP group                                                                                                                                                                                                                                   |
| 6     | reason        | int8  | 1      | `0`=SystemError<br />`1`=InvalidMmpGroup<br />`2`=MmpGroupDisabled<br />`3`=MmpGroupFrozen<br />`4`=TooManyQuotes<br />`5`=InvalidInstrument<br />`6`=RateLimit<br />`7`=PortfolioLocked<br />`8`=DuplicateInstrument<br />`9`=MmpMinFreezeTimeNotElapsed |
