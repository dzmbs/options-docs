...
Each instrument also has an immediate underlying. For options, this will be the associated tradeable or synthetic futures. For futures, this will be the index. The Underlying is visible in the Instrument Definition Message as a text field.
