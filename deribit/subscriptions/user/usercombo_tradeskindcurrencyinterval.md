...
description: >
  ...
  **Block RFQ trades:** Block RFQ does not support combo instruments.
  RFQ-executed trades do not appear in this channel.
servers:
  - id: production
    protocol: wss
                ...
                properties:
                  ...
                  - name: legs
                    ...
                    description: >-
                      ...
                      `starbase_client_order_id`, and `starbase_timestamp` when
                      matched in Starbase.
                    required: false
                  - name: combo_id
                    type: string
            ...
            data:
              ...
              properties:
                ...
                starbase_client_order_id:
                  ...
                  description: >-
                    Client order id of the user's own order (maker or taker
                    side) as sent to Starbase; for self-trades this is the taker
                    order's client order id (present only for trades matched in
                    Starbase)
