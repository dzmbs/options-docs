                ...
                properties:
                  ...
                  - name: original_order_type
                    ...
                    description: >-
                      ...
                      internally as a limit order. For example, Starbase market
                      orders use `"limit"` as `order_type` with `"market"` in
                      this optional field.
                    enumValues:
                      - market
                      - market_limit
                  ...
                  - name: starbase_last_update_timestamp
                    type: integer
                    description: >-
                      The Starbase causal timestamp (nanoseconds since the Unix
                      epoch) of the last book update that affected this order.
                      Present only for orders placed in Starbase, including
                      combo leg order updates; not always available for direct
                      access orders
                    required: false
                  - name: starbase_client_order_id
                    type: string
                    description: >-
                      Client order id sent to Starbase when the order was placed
                      (present only for orders placed in Starbase; combo legs
                      inherit the parent combo order's client order id)
                    required: false
                  - name: direction
                    type: string
                  ...
                  - name: cancel_reason
                    ...
                    description: >-
                      ...
                      `"settlement"` (closed because of a settlement event, e.g.
                      good-til-day orders are cancelled when an instrument
                      enters the daily settlement). Note: orders cancelled
                      because an instrument expired (delivery) currently do not
              ...
              properties:
                ...
                original_order_type:
                  ...
                  description: >-
                    Original API order type when an order is represented
                    internally as a limit order. For example, Starbase market
                    orders use `"limit"` as `order_type` with `"market"` in this
                    optional field.
                  enum:
                    - market
                    - market_limit
                ...
                starbase_last_update_timestamp:
                  ...
                  description: >-
                    The Starbase causal timestamp (nanoseconds since the Unix
                    epoch) of the last book update that affected this order.
                    Present only for orders placed in Starbase, including combo
                    leg order updates; not always available for direct access
                    orders
                ...
                starbase_order_id:
                  ...
                  description: >-
                    Raw Starbase order id, in Starbase's own (non
                    currency-prefixed) id namespace. Only present for orders
                    placed in Starbase. Combo leg orders expose the parent combo
                ...
                cancel_reason:
                  ...
                  description: >-
                    ...
                    because of a settlement event, e.g. good-til-day orders are
                    cancelled when an instrument enters the daily settlement).
                    Note: orders cancelled because an instrument expired
                    (delivery) currently do not include a `cancel_reason` field.
                  enum:
                    - user_request
                    - autoliquidation
                    - cancel_on_disconnect
