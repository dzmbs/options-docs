...
| 9012   | `DeribitShowBlockTradeId` | Boolean    | No                               | To show block trade id. If `9012=Y` and `9011=N` then block trades will include BlockTrade ID as TrdMatchID (880). Default is `N`                                                                                                                                                                                                                                                              |
