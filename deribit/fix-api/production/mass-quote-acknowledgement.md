...
| => 1167 | `QuoteEntryStatus`       | int          | No       | Status of individual Quote Entry. `0` = Accepted, `5` = Rejected, `17` = Cancelled, `18` = Cancelled by MMP, `19` = Replaced, `20` = Filled, `21` = Open, `22` = Closed, `23` = Triggered, `24` = Untriggered, `25` = Unknown                  |
