...
````yaml /specifications/deribit_openapi.json get /public/get_last_trades_by_instrument
openapi: 3.0.0
info:
  title: Deribit API
  version: 2.1.1
  ...
  /public/get_last_trades_by_instrument:
    get:
      tags:
        ...
        - Public
      description: >+
        Retrieves the latest trades that have occurred for a specific
        ...
        [Try in API
        console](https://test.deribit.com/api_console?method=%2Fpublic%2Fget_last_trades_by_instrument)
