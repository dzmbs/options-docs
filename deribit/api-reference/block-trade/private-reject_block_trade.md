...
````yaml /specifications/deribit_openapi.json get /private/reject_block_trade
openapi: 3.0.0
info:
  title: Deribit API
  version: 2.1.1
  ...
  /private/reject_block_trade:
    get:
      tags:
        ...
        - Private
      description: >+
        Rejects a pending block trade. `nonce` and `timestamp` are used to
        ...
        **Scope:** `block_trade:read_write`
        ...
        [Try in API
        console](https://test.deribit.com/api_console?method=%2Fprivate%2Freject_block_trade)
