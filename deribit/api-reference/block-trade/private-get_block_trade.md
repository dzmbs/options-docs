...
````yaml /specifications/deribit_openapi.json get /private/get_block_trade
openapi: 3.0.0
info:
  title: Deribit API
  version: 2.1.1
  ...
  /private/get_block_trade:
    get:
      tags:
        ...
        - Private
      description: >+
        Returns information about a specific block trade identified by
        `block_trade_id`.
        ...
        **Scope:** `block_trade:read`
        ...
        [Try in API
        console](https://test.deribit.com/api_console?method=%2Fprivate%2Fget_block_trade)
