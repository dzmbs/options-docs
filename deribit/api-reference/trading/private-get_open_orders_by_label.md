...
````yaml /specifications/deribit_openapi.json get /private/get_open_orders_by_label
openapi: 3.0.0
info:
  title: Deribit API
  version: 2.1.1
  ...
  /private/get_open_orders_by_label:
    get:
      tags:
        ...
        - Private
      description: >+
        Retrieves a list of all open orders that have a specific label within a
        given currency. This is useful for tracking and managing groups of
        related orders that share the same label.


        Open orders are orders that have been placed but not yet filled or
        cancelled. The label helps organize and identify related orders.
        ...
        **Scope:** `trade:read`
        ...
        [Try in API
        console](https://test.deribit.com/api_console?method=%2Fprivate%2Fget_open_orders_by_label)
