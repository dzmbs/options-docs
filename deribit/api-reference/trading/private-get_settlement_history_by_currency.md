...
> Retrieves settlement, delivery, and bankruptcy events that have affected your account for a specific currency.
...
````yaml /specifications/deribit_openapi.json get /private/get_settlement_history_by_currency
openapi: 3.0.0
info:
  title: Deribit API
  version: 2.1.1
  ...
  /private/get_settlement_history_by_currency:
    get:
      ...
      description: >+
        ...
        your account for a specific currency.
        ...
        **Settlement vs. delivery:** Settlement is a daily event (at 08:00 UTC)
        ...
        histories. This data is useful for tracking account-affecting settlement
        ...
        **Scope:** `trade:read`
        ...
        [Try in API
        console](https://test.deribit.com/api_console?method=%2Fprivate%2Fget_settlement_history_by_currency)
