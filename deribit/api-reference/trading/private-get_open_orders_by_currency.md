...
````yaml /specifications/deribit_openapi.json get /private/get_open_orders_by_currency
openapi: 3.0.0
info:
  title: Deribit API
  version: 2.1.1
  ...
  /private/get_open_orders_by_currency:
    get:
      tags:
        ...
        - Private
      description: >+
        Retrieves a list of all open orders for a specific currency. Open orders
        are orders that have been placed but not yet filled or cancelled.


        Results can be filtered by instrument kind and order type. This method
        provides a view of all active orders within a currency.
        ...
        **Scope:** `trade:read`
        ...
        [Try in API
        console](https://test.deribit.com/api_console?method=%2Fprivate%2Fget_open_orders_by_currency)
