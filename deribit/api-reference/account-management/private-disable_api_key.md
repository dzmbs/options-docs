...
````yaml /specifications/deribit_openapi.json get /private/disable_api_key
openapi: 3.0.0
info:
  title: Deribit API
  version: 2.1.1
  ...
  /private/disable_api_key:
    get:
      tags:
        ...
        - Private
      description: >+
        Disables an API key, preventing it from being used to authenticate API
        requests. The key remains in your account but cannot be used until it is
        re-enabled.


        This is useful for temporarily suspending access without permanently
        deleting the key. All requests using this key will be rejected until it
        is enabled again.
        ...
        **Scope:** `account:read_write`
        ...
        [Try in API
        console](https://test.deribit.com/api_console?method=%2Fprivate%2Fdisable_api_key)
