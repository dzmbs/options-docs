...
````yaml /specifications/deribit_openapi.json get /private/get_subaccounts_details
openapi: 3.0.0
info:
  title: Deribit API
  version: 2.1.1
  ...
  /private/get_subaccounts_details:
    get:
      ...
      description: >+
        ...
        Optionally include open orders for each subaccount by setting the
        `with_open_orders` parameter to `true`.
        ...
        **Scope:** `account:read`
        ...
        [Try in API
        console](https://test.deribit.com/api_console?method=%2Fprivate%2Fget_subaccounts_details)
