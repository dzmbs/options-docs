...
````yaml /specifications/deribit_openapi.json get /private/enable_api_key
openapi: 3.0.0
info:
  title: Deribit API
  version: 2.1.1
  ...
  /private/enable_api_key:
    get:
      tags:
        ...
        - Private
      description: >+
        Enables a previously disabled API key, restoring its ability to
        authenticate API requests. The API key can be used immediately after
        being enabled.
        ...
        **Scope:** `account:read_write`
        ...
        [Try in API
        console](https://test.deribit.com/api_console?method=%2Fprivate%2Fenable_api_key)
