...
````yaml /specifications/deribit_openapi.json get /private/edit_api_key
openapi: 3.0.0
info:
  title: Deribit API
  version: 2.1.1
  ...
  /private/edit_api_key:
    get:
      tags:
        ...
        - Private
      description: >+
        Updates properties of an existing API key. You can modify the key name,
        scope, enabled status, features, and IP whitelist. At least one
        parameter must be provided.


        Changes take effect immediately. If you modify the scope, the API key
        will only have access to the newly specified permissions.
        ...
        **Scope:** `account:read_write`
        ...
        [Try in API
        console](https://test.deribit.com/api_console?method=%2Fprivate%2Fedit_api_key)
              ...
              request:
                value:
                  ...
                  params:
                    name: NewKeyName
                    max_scope: >-
                      account:read_write wallet:read_write block_trade:read
                      trade:read_write
                    id: 3
