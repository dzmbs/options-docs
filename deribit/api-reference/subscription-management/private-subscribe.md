...
````yaml /specifications/deribit_openapi.json get /private/subscribe
openapi: 3.0.0
info:
  title: Deribit API
  version: 2.1.1
  ...
  /private/subscribe:
    get:
      tags:
        ...
        - WebSocket Only
      description: >+
        Subscribe to one or more channels. The name of the channel determines
        ...
        **📖 Related Article:** [Market Data Collection Best
        ...
        [Try in API
        console](https://test.deribit.com/api_console?method=%2Fprivate%2Fsubscribe)
      ...
      parameters:
        ...
        - name: label
          ...
          schema:
            ...
            example: TestLabel1
          description: >-
            Optional label which will be added to notifications of private
            channels (max 16 characters).
      requestBody:
        content:
          application/json:
            examples:
