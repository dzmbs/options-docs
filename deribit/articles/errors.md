...
| 11056       | `"unauthenticated_public_requests_temporarily_disabled"` | Request rejected because unauthenticated public requests were temporarily disabled.                                                                                                                                      |
| 11059       | `"iceberg_not_allowed"`                                  | Iceberg orders rejected on CBE-routed spot instruments.                                                                                                                                                                  |
| 11060       | `"not_supported_for_coinbase_routed_spot"`               | The requested feature is not available on spot instruments routed to Coinbase Exchange.                                                                                                                                  |
...
| 12001       | `"too_many_subaccounts"`                                 | Limit of subaccounts is reached.                                                                                                                                                                                         |
...
| 13040       | `"mmp_required"`                                         | User is not an MMP user.                                                                                                                                                                                                 |
...
| 13911       | `"max_broker_client_count"`                              | Number of broker clients exceeds allowed max amount.                                                                                                                                                                     |
...
| 13922       | `"linked_order_type_not_supported_for_csr_spot"`         | Linked orders (OTO, OCO, OTOCO) are not supported on spot instruments routed to Coinbase Exchange.                                                                                                                       |
