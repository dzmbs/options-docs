...
| --- | --- | --- | --- |
| Perpetual Futures | Per instrument ID | `1` Instrument ID: BTC-USDT-SWAP BTC-USD-SWAP ETH-USDT-SWAP ETH-USD-SWAP | `0.2` |
| Expiry Futures | Per instrument Family | `0.3` Instrument Family: BTC-USDT BTC-USD ETH-USDT ETH-USD | `0.1` |
| Spot | Per instrument ID | `0.5` Instrument ID: BTC-USDT ETH-USDT | `0.1` |
