  ...
  "paths": {
    "/private/get_order": {
      "post": {
        ...
        "summary": "Get Order",
        "description": "Get state of an order by order id.  If the order is an MMP order, it will not show up if cancelled/expired.\nRequired minimum session key permission level is `read_only`",
        "responses": {
          "200": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/PrivateGetOrderResponseSchema"
                }
              }
            }
          }
        ...
        "requestBody": {
          ...
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/PrivateGetOrderParamsSchema"
              }
            }
          }
        }
