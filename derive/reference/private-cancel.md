---
updatedAt: 2026-02-24T23:10:38.000Z
---
...
Cancel a single order.<br /><br />Other `private/cancel_*` routes are available through both REST and WebSocket.<br />Required minimum session key permission level is `admin`
