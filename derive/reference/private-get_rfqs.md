...
Retrieves a list of RFQs matching filter criteria. Takers can use this to get their open RFQs, RFQ history, etc.<br />Required minimum session key permission level is `read_only`
      ...
      <tbody>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            ...
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>integer</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>Earliest <code>last\_update\_timestamp</code> to filter by (in ms since Unix epoch). If not provied, defaults to 0.</span>
          </td>
        </tr>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            ...
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>string</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>RFQ ID filter, if applicable</span>
          </td>
        </tr>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            ...
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>string</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>RFQ status filter, if applicable</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>enum </span><code>open</code> <code>filled</code> <code>cancelled</code> <code>expired</code>
          </td>
        </tr>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            ...
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>integer</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>Latest <code>last\_update\_timestamp</code> to filter by (in ms since Unix epoch). If not provied, defaults to returning all data up to current time.</span>
          </td>
        </tr>
      </tbody>
    </table>
      ...
      <tbody>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            ...
            <strong>ask\_total\_cost</strong> 
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>string or null</span> <span className="ws-required-tag ws-small-font" style={{color: "#e95f6a", marginLeft: "8px", fontSize: "13px"}}>required</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>Ask total cost for the RFQ implied from orderbook (as <code>sell</code>)</span>
          </td>
        </tr>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.rfqs\[].</span>
            <strong>bid\_total\_cost</strong> 
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>string or null</span> <span className="ws-required-tag ws-small-font" style={{color: "#e95f6a", marginLeft: "8px", fontSize: "13px"}}>required</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>Bid total cost for the RFQ implied from orderbook (as <code>buy</code>)</span>
          </td>
        </tr>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            ...
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>array of strings or null</span> <span className="ws-required-tag ws-small-font" style={{color: "#e95f6a", marginLeft: "8px", fontSize: "13px"}}>required</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>List of requested counterparties, if applicable</span>
          </td>
        </tr>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.rfqs\[].</span>
            <strong>filled\_direction</strong> 
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>string or null</span> <span className="ws-required-tag ws-small-font" style={{color: "#e95f6a", marginLeft: "8px", fontSize: "13px"}}>required</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>Direction at which the RFQ was filled (only if filled)</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>enum </span><code>buy</code> <code>sell</code>
          </td>
        </tr>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.rfqs\[].</span>
            <strong>filled\_pct</strong> 
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>string</span> <span className="ws-required-tag ws-small-font" style={{color: "#e95f6a", marginLeft: "8px", fontSize: "13px"}}>required</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>Percentage of the RFQ that has been filled, from 0 to 1.</span>
          </td>
        </tr>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.rfqs\[].</span>
            <strong>mark\_total\_cost</strong> 
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>string or null</span> <span className="ws-required-tag ws-small-font" style={{color: "#e95f6a", marginLeft: "8px", fontSize: "13px"}}>required</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>Mark total cost for the RFQ (assuming <code>buy</code> direction)</span>
          </td>
        </tr>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.rfqs\[].</span>
            <strong>max\_total\_cost</strong> 
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>string or null</span> <span className="ws-required-tag ws-small-font" style={{color: "#e95f6a", marginLeft: "8px", fontSize: "13px"}}>required</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>Max total cost for the RFQ</span>
          </td>
        </tr>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.rfqs\[].</span>
            <strong>min\_total\_cost</strong> 
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>string or null</span> <span className="ws-required-tag ws-small-font" style={{color: "#e95f6a", marginLeft: "8px", fontSize: "13px"}}>required</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>Min total cost for the RFQ</span>
          </td>
        </tr>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.rfqs\[].</span>
            <strong>partial\_fill\_step</strong> 
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>string</span> <span className="ws-required-tag ws-small-font" style={{color: "#e95f6a", marginLeft: "8px", fontSize: "13px"}}>required</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>Step size for partial fills (default: 1)</span>
          </td>
        </tr>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.rfqs\[].</span>
            <strong>total\_cost</strong> 
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>string or null</span> <span className="ws-required-tag ws-small-font" style={{color: "#e95f6a", marginLeft: "8px", fontSize: "13px"}}>required</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>Total cost for the RFQ (only if filled)</span>
          </td>
        </tr>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.rfqs\[].</span>
            <strong>valid\_until</strong> 
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>integer</span> <span className="ws-required-tag ws-small-font" style={{color: "#e95f6a", marginLeft: "8px", fontSize: "13px"}}>required</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>RFQ expiry timestamp in ms since Unix epoch</span>
          </td>
        </tr>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            ...
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>string</span> <span className="ws-required-tag ws-small-font" style={{color: "#e95f6a", marginLeft: "8px", fontSize: "13px"}}>required</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>Wallet address of the RFQ sender</span>
          </td>
        </tr>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.rfqs\[].legs\[].</span>
