---
updatedAt: 2026-04-10T17:51:29.000Z
---
...
<div className="rdmd-table">
  ...
  <td style={{textAlign: "left"}}>
    <span className="ws-small-font"></span>
    <strong>from_timestamp</strong>&nbsp;
    <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>integer</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>Earliest <code>last_update_timestamp</code> to filter by (in ms since Unix epoch). If not provied, defaults to 0.</span>
  </td>
</tr><tr>
  <td style={{textAlign: "left"}}>
    <span className="ws-small-font"></span>
...
<div className="rdmd-table">
  ...
  <td style={{textAlign: "left"}}>
    <span className="ws-small-font">result.rfqs[].</span>
    <strong>filled_direction</strong>&nbsp;
  ...
  <td style={{textAlign: "left"}}>
    <span className="ws-small-font">result.rfqs[].</span>
    <strong>reducing_direction</strong>&nbsp;
