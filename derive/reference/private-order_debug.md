---
updatedAt: 2026-02-27T16:04:49.000Z
---
...
Debug a new order<br />Required minimum session key permission level is `read_only`
...
<div className="rdmd-table">
  ...
  <td style={{textAlign: "left"}}>
    <span className="ws-small-font">result.raw_data.</span>
  ...
  <td style={{textAlign: "left"}}>
    <span className="ws-small-font">result.raw_data.data.</span>
    <strong>asset</strong>&nbsp;
    <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>string</span>&nbsp;<span className="ws-required-tag ws-small-font" style={{color: "#e95f6a", marginLeft: "8px", fontSize: "13px"}}>required</span>
  </td>
</tr><tr>
