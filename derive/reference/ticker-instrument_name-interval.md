---
updatedAt: 2026-02-17T18:10:20.000Z
---
...
<div className="rdmd-table">
  ...
  <td style={{textAlign: "left"}}>
    <span className="ws-small-font">data.instrument_ticker.erc20_details.</span>
  ...
  <td style={{textAlign: "left"}}>
    <span className="ws-small-font">data.instrument_ticker.option_details.</span>
  ...
  <td style={{textAlign: "left"}}>
    <span className="ws-small-font">data.instrument_ticker.perp_details.</span>
