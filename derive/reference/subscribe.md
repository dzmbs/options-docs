---
updatedAt: 2025-10-08T19:46:44.000Z
---
...
<div className="rdmd-table">
  ...
  <td style={{textAlign: "left"}}>
    ...
    <strong>current_subscriptions</strong>&nbsp;
    <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>array&nbsp;of&nbsp;strings</span>&nbsp;<span className="ws-required-tag ws-small-font" style={{color: "#e95f6a", marginLeft: "8px", fontSize: "13px"}}>required</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>A list of channels subscribed to after the subscribe operation.</span>
  </td>
</tr><tr>
  <td style={{textAlign: "left"}}>
    <span className="ws-small-font">result.</span>
    <strong>status</strong>&nbsp;
    <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>object</span>&nbsp;<span className="ws-required-tag ws-small-font" style={{color: "#e95f6a", marginLeft: "8px", fontSize: "13px"}}>required</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>A mapping of <code>channel</code>&nbsp;&#11106;&nbsp;<code>status</code>.<br />Successful subscriptions will have status <code>ok</code>.<br />Failed subscriptions will contain an error message.</span>
  </td>
</tr></tbody>
    </table>
  </div>
