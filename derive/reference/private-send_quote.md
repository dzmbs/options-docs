...
Sends a quote in response to an RFQ request.<br />The legs supplied in the parameters must exactly match those in the RFQ.<br />Required minimum session key permission level is `admin`
