---
updatedAt: 2025-10-08T19:46:31.000Z
---
...
<div className="rdmd-table">
  ...
  <td style={{textAlign: "left"}}>
    <span className="ws-small-font"></span>
    <strong>scope</strong>&nbsp;
    <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>string</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>Scope of the session key. If not included it is assumed to be read only. Options are [KeyScope.ACCOUNT, KeyScope.READ_ONLY]</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>enum </span><code>admin</code> <code>account</code> <code>read_only</code>
  </td>
</tr></tbody>
    </table>
  </div>
