...
Retrieves a list of RFQs matching filter criteria. Market makers can use this to poll RFQs directed to them.<br />Required minimum session key permission level is `read_only`
      ...
      <tbody>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            ...
            <strong>rfq\_subaccount\_id</strong> 
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>integer</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>Filter returned RFQs by rfq requestor subaccount</span>
          </td>
        </tr>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.rfqs\[].</span>
            <strong>fill\_rate</strong> 
            <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>string or null</span> <span className="ws-required-tag ws-small-font" style={{color: "#e95f6a", marginLeft: "8px", fontSize: "13px"}}>required</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>Average taker fill rate, from 0 to 1. Returns null for users with insufficient RFQ history.</span>
          </td>
        </tr>
