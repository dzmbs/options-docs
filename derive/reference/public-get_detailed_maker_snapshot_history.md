    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.snapshots\[].</span>
            <strong>deducted\_factor</strong> 
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.snapshots\[].</span>
            <strong>deducted\_notional</strong> 
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.snapshots\[].</span>
            <strong>instrument\_factor</strong> 
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.snapshots\[].</span>
            <strong>scaled\_notional</strong> 
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.snapshots\[].</span>
            <strong>total\_scaled\_notional</strong> 
