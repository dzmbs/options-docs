  ...
  <div className="rdmd-table-inner">
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.instruments\[].erc20\_details.</span>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.instruments\[].option\_details.</span>
        ...
        <tr>
          <td style={{textAlign: "left"}}>
            <span className="ws-small-font">result.instruments\[].perp\_details.</span>
