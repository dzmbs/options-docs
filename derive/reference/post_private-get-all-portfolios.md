  ...
  "paths": {
    "/private/get_all_portfolios": {
      "post": {
        ...
        "description": "Get all portfolios of a wallet\nRequired minimum session key permission level is `read_only`",
        "responses": {
          "200": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/PrivateGetAllPortfoliosResponseSchema"
                }
              }
            }
          }
        ...
        "requestBody": {
          ...
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/PrivateGetAllPortfoliosParamsSchema"
              }
            }
          }
        }
