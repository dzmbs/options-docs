---
updatedAt: 2026-02-05T15:29:56.000Z
---
...
1. [Deposit to Derive Chain](https://docs.derive.xyz/docs/deposit-to-lyra-chain)
2. [Create or Deposit to Subaccount](https://docs.derive.xyz/docs/create-or-deposit-to-subaccount)
3. [Manage Session Keys](https://docs.derive.xyz/docs/on-chain-manage-session-keys)