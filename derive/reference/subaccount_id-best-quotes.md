---
updatedAt: 2025-10-08T19:42:12.000Z
---
...
<div className="rdmd-table">
  ...
  <td style={{textAlign: "left"}}>
    <span className="ws-small-font">data[].</span>
    <strong>error</strong>&nbsp;
    <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>object&nbsp;or&nbsp;null</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>Error if the the <code>rfq_get_best_quote</code> RPC call failed</span>
  </td>
</tr><tr>
  <td style={{textAlign: "left"}}>
  ...
  <td style={{textAlign: "left"}}>
    <span className="ws-small-font">data[].result.best_quote.</span>
  ...
  <td style={{textAlign: "left"}}>
    <span className="ws-small-font">data[].result.best_quote.legs[].</span>
