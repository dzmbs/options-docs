---
updatedAt: 2025-10-08T19:42:53.000Z
---
...
Cancels a single RFQ by id.<br />Required minimum session key permission level is `account`
...
<div className="rdmd-table">
  ...
  <td style={{textAlign: "left"}}>
    ...
    <span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>string</span>&nbsp;<span className="ws-required-tag ws-small-font" style={{color: "#e95f6a", marginLeft: "8px", fontSize: "13px"}}>required</span><br /><span className="ws-data-type ws-small-font" style={{color: "#adb4c1", fontSize: "13px"}}>RFQ ID to cancel</span>
  </td>
</tr><tr>
  <td style={{textAlign: "left"}}>
    <span className="ws-small-font"></span>
